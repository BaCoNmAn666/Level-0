...
public class SimplePainter extends JPanel implements KeyListener, MouseListener {
	...
	SimplePainter j = new SimplePainter();
	}
...
if(e.getKeyCode() == KeyEvent.VK_PAGE_DOWN){
	System.out.println("JK not really tho, im just frustrated");
}
	}
