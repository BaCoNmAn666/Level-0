...
frame.setVisible(true);
	...
	JPanel bill = createHeader("MEMES");
...
frame.add(quizPanel);
	...
	private void askQuestion(String question, String correctAnswer, String prizeMoney) {
		// Remove this temporary message
		JOptionPane.showMessageDialog(null, "this is where the question will be asked.  (Hint - Capitalize the word)");
		// Use a pop up to ask the user the question
String POP =  JOptionPane.showInputDialog("Who was the dead gorilla meme?");
		// If the answer is correct
		if(POP.equals("Harambe")){
			prizeMoney = firstButton.getText();
			int b
			updateScore();
